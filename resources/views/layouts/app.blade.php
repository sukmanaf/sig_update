...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- <script src="{{asset('custom/mapbox/mapbox-gl.js')}}"></script> -->
        <!-- <script src="{{asset('custom/mapbox/leaflet-mapbox-gl.js')}}"></script> -->
        ...
        <!-- <script src="{{asset('js/leaflet.polydrag.js')}}"></script> -->
